...
```
## Execute
All the necessary parameters for running all the scripts are stored in the [**params.py**](params.py) file. Change the [**data/regions.csv**](data/regions.csv) file for defining different regions
